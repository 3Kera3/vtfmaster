...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "fr": {
        ...
        "reprocess_all_vmt": "Repasser sur tous les VMT existants",
        "vmt_options": "Options VMT :",
        "opt_nocull": "nocull",
        "opt_alphatest": "alphatest",
        "opt_translucent": "translucent",
        "tex_size": "Taille des textures VTF :",
        "preset_label": "Preset VMT à utiliser :",
        "preset_props": "Props (VertexLitGeneric)",
        "preset_map_hammer": "Map / Hammer (LightmappedGeneric)",
        "vmt_edit_preset_select": "Preset à éditer :",
        ...
        "about_text": (
            ...
            "Version : 3.1.0\n\n"
            "Nouveautés (3.1.0) :\n"
            "• Options VMT : cases à cocher nocull, alphatest, translucent\n"
            "• Repasser sur tous les VMT existants du dossier destination\n"
            "• Nettoyage du code : plus de templates dupliqués\n\n"
            "Nouveautés (3.0.0) :\n"
    ...
    "en": {
        ...
        "reprocess_all_vmt": "Reprocess all existing VMTs",
        "vmt_options": "VMT Options:",
        "opt_nocull": "nocull",
        "opt_alphatest": "alphatest",
        "opt_translucent": "translucent",
        "tex_size": "VTF texture size:",
        "preset_label": "VMT Preset to use:",
        "preset_props": "Props (VertexLitGeneric)",
        "preset_map_hammer": "Map / Hammer (LightmappedGeneric)",
        "vmt_edit_preset_select": "Preset to edit:",
        ...
        "about_text": (
            ...
            "Version: 3.1.0\n\n"
            "What's new (3.1.0):\n"
            "• VMT options: nocull, alphatest, translucent checkboxes\n"
            "• Reprocess all existing VMTs in destination folder\n"
            "• Code cleanup: no more duplicated templates\n\n"
            "What's new (3.0.0):\n"
